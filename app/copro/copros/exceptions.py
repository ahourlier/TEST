...
class PresidentNotFoundException(HTTPException):
    def __init__(self, message=PRESIDENT_NOT_FOUND_EXCEPTION):
        self.code = 404
        self.key = KEY_PRESIDENT_NOT_FOUND_EXCEPTION
        self.message = message
        self.status = "NOT FOUND"
