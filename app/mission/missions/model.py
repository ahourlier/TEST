...
class Mission(SoftDeletableMixin, BaseMixin, db.Model):
    ...
    sdv2_operationel_drive = db.Column(String(255), nullable=True)
    sdv2_operationel_folder = db.Column(String(255), nullable=True)
    sdv2_administratif_drive = db.Column(String(255), nullable=True)
    sdv2_administratif_folder = db.Column(String(255), nullable=True)
    sdv2_suivi_animation_folder = db.Column(String(255), nullable=True)
    sdv2_outils_animation_folder = db.Column(String(255), nullable=True)
    sdv2_equipes_locales_folder = db.Column(String(255), nullable=True)
