...
from .schema import (
    ...
    CombinedStructurePaginatedSchema,
    CombinedStructureCreateSchema,
    CombinedStructureUpdateSchema,
)
from .service import (
    SEARCH_COMBINED_STRUCTURES_PARAMS,
    CombinedStructureService,
    COMBINED_STRUCTURE_DEFAULT_PAGE,
    COMBINED_STRUCTURE_DEFAULT_PAGE_SIZE,
    COMBINED_STRUCTURE_DEFAULT_SORT_FIELD,
    COMBINED_STRUCTURE_DEFAULT_SORT_DIRECTION,
)
    ...
    def get(self) -> Pagination:
        return CombinedStructureService.list(
            ...
            direction=request.args.get(
                "sortDirection", COMBINED_STRUCTURE_DEFAULT_SORT_DIRECTION
            ),
...
class CombinedStructuresResource(AuthenticatedApi):
    ...
    def put(self, cs_id):
        ...
        return CombinedStructureService.update(
            db_combined_structure, cs_id, request.parsed_obj
        )
