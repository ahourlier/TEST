...
def register_internal_routes(bp):
    ...
    from app.mail import register_internal_routes as register_internal_email_routes
    ...
    from app.v2_exports import (
        register_internal_routes as register_internal_exports_routes,
    )
    ...
    register_internal_exports_routes(bp)
